...
First let's check that the view exists
    ...
    >>> from plonetheme.ewb_case.browser.ewb_caseview import themeView
...
visible.
    ...
    >>> from plonetheme.ewb_case.tests.base import zcml_string
    >>> zcml.load_string(zcml_string)
    >>> portal_setup = self.portal.portal_setup
    >>> portal_setup.runAllImportStepsFromProfile('profile-plonetheme.ewb_case:testing')
    {...}
    >>> browser.reload()
    >>> 'id="portal-column-one"' in browser.contents
    False
